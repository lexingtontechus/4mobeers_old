...
export default function Privacy() {
  return (
    <>
      <SEO title="Privacy | 4MoBeers" description="Privacy 4MoBeers." />
      <Navbar transparent />
                ...
                >
                  <Collapse title="GENERAL NOTICE" expanded>
                    <p className="text-sm text-trueZinc-700">
                      ...
                      4MoBeers DAO Inc, doing business as 4MoBeers
                      (&quot;4MoBeers Inc.,&quot; &quot;we,&quot;
                      ...
                      delsolventures@skiff.com. This privacy notice describes
                      how we might use your information if you visit our
                      website:
                    </p>
                    <Link
                  ...
                  <Collapse title="10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?">
                    ...
                    <Link
                      className="text-sm font-bold"
                      href="https://4MoBeers.nft/contact"
                    >
                      https://4MoBeers.nft/contact
                    </Link>
                    <p className="text-sm text-trueZinc-700">
                      ...
                      data. 4MoBeers has not disclosed or sold any personal
                      information to third parties for a business or commercial
                      purpose in the preceding 12 months. 4MoBeers will not sell
                      ...
                      contact us by email at legal@4MoBeers.nft, by visiting
                    </p>
                    <Link
                      className="text-sm font-bold"
                      href="https://4MoBeers.nft/contact"
                  ...
                  <Collapse title="12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?">
                    <p className="text-sm text-trueZinc-700">
                      ...
                      may email us at legal@4MoBeers.nft or by post to:
                    </p>
                    <p className="text-sm text-trueZinc-700">
                      4MoBeers DAO Inc.
                      <br />
