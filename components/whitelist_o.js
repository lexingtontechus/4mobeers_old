...
export default function Whitelist() {
  ...
  return (
    <div className="container mx-auto flex w-10/12 w-full flex-wrap place-content-center p-8">
      ...
      <div className="h-full flex-grow overflow-auto bg-trueBlue-300 p-6 dark:bg-trueZinc-900">
        {!isSubmitSuccessful && (
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <input
              ...
              {...register("subject")}
            />
            <input type="hidden" value="4MoBeers" {...register("from_name")} />
            <input
              type="checkbox"
              className="hidden"
              style={{ display: "none" }}
            ...
            <div className="mb-4 px-4">
              ...
              <input
                ...
                className={`w-full rounded-md border border-trueZinc-300 bg-trueZinc-100 px-3 py-2 placeholder-trueZinc-700 focus:outline-none focus:ring   ${
                  errors.beername
